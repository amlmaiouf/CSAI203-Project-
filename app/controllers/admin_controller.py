"""
Admin Controller - FR15 Admin Service Management
...
def dashboard():
    ...
    # Get top services (all services with their stats)
...
def services_list():
    ...
    # Add computed properties to each service
    for svc in services:
...
def edit_employee(user_id):
    ...
    if request.method == 'POST':
        ...
        if new_password:
            ...
            employee.password = None  # Signal to not update password
...
# ==================== SERVICE PERFORMANCE (FR15.3) ====================

@admin_bp.route('/performance')
@login_required
@admin_required
def service_performance():
    """View service performance analytics"""
    services = Service.get_all()
    
    # Build performance data for each service
    performance_data = []
    for svc in services:
        request_count = svc.get_request_count()
        ...
        performance_data.append({
            ...
            'avg_rating': avg_rating,  # Fixed: was 'average_rating'
